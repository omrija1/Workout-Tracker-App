...
class MainDashboard(BaseScreen):
    ...
    def init_ui(self, quote_text):
        ...
        self.layout.add_widget(Button(text='Go to Screen 1', size_hint_y=None, height=50,
                                      on_press=self.manager_instance.navigate_to_screen('screen_1')))
        self.layout.add_widget(Button(text='Go to Settings', size_hint_y=None, height=50,
